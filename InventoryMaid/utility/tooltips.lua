...
function tooltips.draw(InventoryMaid, show, key)
    if show then
        if key == "sellFilter" then
            InventoryMaid.CPS.CPToolTip1Begin(500, 190)
        ...
        elseif key == "perType" then
            InventoryMaid.CPS.CPToolTip1Begin(500, 110)
        ...
        elseif key == "sellAll" then
            InventoryMaid.CPS.CPToolTip1Begin(500, 55)
